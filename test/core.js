...
document.getElementById('terminalContentsResult').innerHTML = "<strong>Welcome to Isac's interactive portfolio!</strong><br><br>   "+
                                                           ...
                                                           "I can assure you that this terminal is completely harmless as it runs here in your browser, so do not fear typing anything, but if you are still in doubt, here is a harmless cyber duck:<br>"+
                                                           // "This terminal is completely harmless as it runs here in your browser, it is unable to do any harm to your device. "+
                                                           // "I can assure you that, but for more trust, here is a picture of a harmless cyber duck:<br>"+
